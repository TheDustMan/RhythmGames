...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "GamepadTest", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "GamepadTest";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "GamepadTest", null, { width: 526, height: 376 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 526, height: 376 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 526, 376, "null");
		#end
		#else
		create ();
		#end
