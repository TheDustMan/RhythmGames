...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/LB.png", AssetType.IMAGE);
		path.set ("assets/images/miss.png", "assets/images/miss.png");
		type.set ("assets/images/miss.png", AssetType.IMAGE);
		path.set ("assets/images/RB.png", "assets/images/RB.png");
		type.set ("assets/images/RB.png", AssetType.IMAGE);
		...
		type.set ("assets/images/Stick.png", AssetType.IMAGE);
		path.set ("assets/images/X.png", "assets/images/X.png");
		type.set ("assets/images/X.png", AssetType.IMAGE);
		path.set ("assets/images/xbox360_gamepad.png", "assets/images/xbox360_gamepad.png");
		type.set ("assets/images/xbox360_gamepad.png", AssetType.IMAGE);
		path.set ("assets/images/Y.png", "assets/images/Y.png");
		type.set ("assets/images/Y.png", AssetType.IMAGE);
		path.set ("assets/sounds/classic.ogg", "assets/sounds/classic.ogg");
		type.set ("assets/sounds/classic.ogg", AssetType.SOUND);
		path.set ("assets/sounds/gamebeat.ogg", "assets/sounds/gamebeat.ogg");
		type.set ("assets/sounds/gamebeat.ogg", AssetType.SOUND);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/LB.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/miss.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/RB.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Start.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Stick.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/X.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/xbox360_gamepad.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Y.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sounds/classic.ogg";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
		id = "assets/sounds/gamebeat.ogg";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
