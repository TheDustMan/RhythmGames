...
Void Main_obj::setupGame( ){
{
		...
		if ((tmp7)){
			...
			HX_STACK_LINE(59)
			int tmp9 = ::Globals_obj::gameWidth;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(59)
			...
			HX_STACK_LINE(60)
			int tmp12 = ::Globals_obj::gameHeight;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(60)
			...
			HX_STACK_LINE(63)
			::Globals_obj::gameHeight = tmp24;
		}
		HX_STACK_LINE(66)
		int tmp8 = ::Globals_obj::gameWidth;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(66)
		int tmp9 = ::Globals_obj::gameHeight;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(66)
