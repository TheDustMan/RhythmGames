...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/A.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/B.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/Back.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/LB.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/RB.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/Stick.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/X.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/xbox360_gamepad.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/Y.png");
		types.push (lime.Assets.AssetType.IMAGE);
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 526, 376, "000000");
		#end
		#else
		create ();
		#end
