 ...
 * @author DustMan
 */
class PenguinEntity extends Actor
{
	...
	private var _penguin:FlxSprite;
	...
	public function new(activelyControllable:Bool=false) 
	{
		...
		_penguin = new FlxSprite(250, 50);
		_penguin.loadGraphic("assets/images/pengo_small.png");
